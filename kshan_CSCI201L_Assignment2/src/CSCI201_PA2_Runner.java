...
public class CSCI201_PA2_Runner {
    ...
    public static InputCodes[] inputParse() {
        ...
        while (running) {
            ...
            try {
                ...
                //ArrayList<InputCodes> codes = gson.fromJson(file, new TypeToken<ArrayList<InputCodes>>(){}.getType());
                InputCodes[] codes = gson.fromJson(file, InputCodes[].class);
                //ArrayList<Data> data = gson.fromJson(file, new TypeToken<ArrayList<Data>>(){}.getType());
                running = false;
                return codes;
            }
    ...
    public static void handler(Dictionary D) {
        ...
        while (running) {
            ...
            String useless = inputSC.nextLine();
    ...
    public static void main(String[] args) {
        ...
        for (InputCodes temp : codes) {
            for (int i = 0; i < temp.codes.length; i++) {
                InputCodes.add((String) temp.codes[i]);
            }
        }
